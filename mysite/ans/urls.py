...
urlpatterns = [
    ...
    # /ans/question/userid
    url(r'^question/user/(?P<user_id>[0-9]+)/$', views.asked_by_me, name='asked_by_me'),

    # /ans/answer/username
    url(r'^answer/user/(?P<user_id>[0-9]+)/$', views.answered_by_me, name='answered_by_me'),


    url(r'^upvote/user/(?P<user_id>[0-9]+)/$', views.upvoted_by_me, name='upvoted_by_me'),
